...
private:
    ...
    void createCommandBuffers(){
        ...
        for (size_t i = 0; i < commandBuffers.size(); i++) {
            ...
            vkCmdDrawIndexed(commandBuffers[i], static_cast<uint32_t>(shape.getInd().size()), 1, 0, 0, 0);
    ...
    void createVertexBuffer(){
        ...
        VkDeviceSize bufferSize = sizeof(shape.getVert()[0]) * shape.getVert().size();
        ...
        memcpy(data, shape.getVert().data(), (size_t) bufferSize);
    ...
    void createIndexBuffer(){
        VkDeviceSize bufferSize = sizeof(shape.getInd()[0]) * shape.getInd().size();
        ...
        void* data;
        vkMapMemory(device, stagingBufferMemory, 0, bufferSize, 0, &data);
        memcpy(data, shape.getInd().data(), (size_t) bufferSize);
        vkUnmapMemory(device, stagingBufferMemory);
